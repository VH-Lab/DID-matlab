...
%                of assuming it across a 70-minute corpus run: checkcode clean
%                in the edited region, all three helpers resolving, and a
%                writeCorpusReport round trip through jsondecode.
