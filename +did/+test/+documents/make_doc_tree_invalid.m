function [G, node_names, docs] = make_doc_tree_invalid(rates, method)
% MAKE_DOC_TREE - make a "tree" of documents to add to a database
%
% [G, NODE_NAMES, DOCS] = MAKE_DOC_TREE_INVALID(RATES, METHOD)
%
...
for i=1:numA,
	docs{end+1} = did.document('demoA','demoA.value',modifyvalue(method,counter));
