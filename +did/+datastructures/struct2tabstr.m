...
%
% S = did.datastructures.struct2tabstr(A)
%
...
%
% See also: did.file.loadStructArray, did.file.saveStructArray, did.datastructures.tabstr2struct
%
% Example:
%    a.fielda = 5;
...
%    s = did.datastructures.struct2tabstr(a)
%    % convert back
%    a2 = did.datastructures.tabstr2struct(s, {'fielda','fieldb'} )
%
