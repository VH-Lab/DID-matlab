...
%
% A = did.datastructures.tabstr2struct(S, FIELDS)
%
...
%
% See also: did.file.loadStructArray, did.file.saveStructArray, DLMREAD, DLMWRITE, did.datastructures.struct2tabstr
%
% Example:
%   s = ['5' char(9) 'my string data'];
%   fn = {'fielda','fieldb'};
%   a = did.datastructures.tabstr2struct(s,fn)
% 
