function b = fieldsearch(A, searchstruct)
    ...
    %
    % B = did.datastructures.fieldsearch(A, SEARCHSTRUCT)
    %
    ...
    %     b1=did.datastructures.fieldsearch(A,struct('field','a','operation','contains_string','param1','test','param2',''))
    %     b2=did.datastructures.fieldsearch(A,struct('field','b','operation','greaterthaneq','param1',1,'param2',''))
    %
    %     B = struct('values',A);
    %     b3=did.datastructures.fieldsearch(B,struct('field','values','operation','hasanysubfield_contains_string','param1','a','param2','string_test'))
    %
    %     b4=did.datastructures.fieldsearch(A,struct('field','','operation','or', ...
    ...
    [isthere, value] = did.datastructures.isfullfield(A,searchstruct.field);
