function saveStructArray(fname,gdi,header)
    ...
    %
    %   did.file.saveStructArray(FILENAME, STRUCTARRAY, [HEADER])
    %
    ...
    %   did.file.loadStructArray).  The input argument HEADER is optional
    ...
    %
    %   See also: did.file.loadStructArray, STRUCT, did.datastructures.tabstr2struct
    %
