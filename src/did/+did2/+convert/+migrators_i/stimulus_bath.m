...
%
%   Same disposition as the Brainstorm-E path. The legacy stimulus_bath is
%   really a bath (pharmacological_manipulation): its mixture/location live in
%   the document, but the resulting bath needs two things that can only be
%   obtained by following stimulus_element_id to the stimulator ELEMENT and
%   its session/epoch graph --
%
...
%   partial. See ndi.migrate.internal.stimulusBathToBath (NDI-matlab).
