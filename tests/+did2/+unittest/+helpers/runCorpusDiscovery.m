...
% TWO PASSES ARE DELIBERATELY NOT IN THIS LIST, and saying so is the point --
% an omission nobody wrote down is the thing this whole file exists to stop.
% `response_parameters_fold` and `lawn_plate_subjects` are both new and have
% NEVER BEEN EXECUTED, and making a throw fatal for an unexecuted pass
