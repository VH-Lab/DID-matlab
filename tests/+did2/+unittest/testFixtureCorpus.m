...
d.app = struct('app_name','ndi.calc.vis.oridir','app_version','1.2');
...
d.app = struct('app_name','ndi.calc.vis.contrast_sensitivity','app_version','1.0');
...
d.app = struct('app_name','ndi.calc.stimulus.tuningcurve','app_version','1.0');
